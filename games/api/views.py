...
from games.models import Game, Developer, Publisher, Reviews
from games.api.serializer import (GameListSerializer,
...
from games.api.permissions import IsAdminOrIsAuthenticated
